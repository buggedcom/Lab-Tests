...
describe('Screenshot /delete confirm:hover', function() {
    ...
    before(async function() {
        ...
        page = await testPage();
        await page.click('#root > section > div > main > ul > li:nth-child(1) > button.ButtonTrash');
    ...
    sizes.forEach((width) => {
        it(`screenshot at ${width}x${height}`, function(done) {
            page.hover('body > div.ReactModalPortal > div > div > section > footer > div.buttons.buttons--right > button');
