...
describe('Screenshot /performChecks pass', function(){
    ...
    before(async function() {
        ...
        await page.type('body > div.ReactModalPortal > div > div > section > main > form > table > tbody > tr.value > td.input > input[type="number"]', '1');
        const watchDog = page.waitForFunction(`document.querySelector('.status-message.status-message--success')`);
