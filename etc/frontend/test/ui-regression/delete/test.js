...
describe('Screenshot /delete', function() {
    ...
    before(async function() {
        ...
        page = await testPage();
        await page.click('#root > section > div > main > ul > li:nth-child(1) > button._Button._Button--size-small._Button--theme-secondary._Button--theme-secondary._Button--stripe._ButtonAction._ButtonAction--primary.ButtonTrash');
